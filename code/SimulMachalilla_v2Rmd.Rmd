...
---
title       : Simulación de datos de ocupación, bajo el modelo estático (MacKenzie et al. 2002) para el venado de cola blanca en el Parque Nacional Machalilla
subtitle    : Entendiendo las simulaciones y el modelo básico. Gran parte del código y el texto han sido adaptados de los libros de [Marc Kery (2010, 2011, y 2015).](https://www.amazon.com/Introduction-WinBUGS-Ecologists-Bayesian-regression/dp/0123786053/ref=pd_bxgy_14_img_2?ie=UTF8&psc=1&refRID=WKY41VDAMZ9Q6TRAMY8M)
...
output:
  html_document:
    toc: yes
    toc_depth: '3'
    highlight   : pygments  # {highlight.js, prettify, highlight}
